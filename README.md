...
- Repo: `aismbagency/litlocals-site`
...
Nine-section scroll: need, why it matters, the upgrade, before/after, looks, buy/install, terms, extra packages (inquire only), close. FAQ sits before the final buy. Sticky header CTA emails hello@ with subject "I want the website upgrade".
